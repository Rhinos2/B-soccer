...
GLshort OLDFONT::FONT_init(AssetReader& assetReader)
{

    fontprg = new MYPROGRAM((GLchar *) "FontProgram");
    if(0 != fontprg->PROGRAM_create(assetReader, (GLchar*)"font_shader.vert", (GLchar*)"font_shader.frag", true))
        return -1;
...
GLshort OLDFONT::FONT_load(AssetReader& assetReader, GLchar *filename,  GLfloat font_size, GLuint texture_width, GLuint texture_height,
                           GLint first_character, GLint count_character)
{
    if(0 != assetReader.readAssetFile(filename)) {
        ...
        stbtt_BakeFontBitmap((GLubyte*)assetReader.getaBuffer(), 0, font_size, texel_array, texture_width, texture_height,
                             first_character, count_character, this->character_data );
...
void OLDFONT::FONT_print(GLfloat x, GLfloat y, const GLchar *text, glm::mat4& prj, glm::vec4& color)
{
////////////////////////////////////////////////////////////////////////////
